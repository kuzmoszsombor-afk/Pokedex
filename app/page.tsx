...
import PokemonDetails from '../components/PokemonDetails'; // Beimportáljuk a kész komponenst
...
export default function Home() {
  ...
  // Ha van kiválasztott pokémon, akkor a Részletes Nézetet töltjük be
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {selectedType ? (
              ...
              <div className="col-span-full text-center text-gray-400 italic py-10 border-2 border-dashed rounded-lg">
